...
const resources = {
  ...
  "contact":{
    "header1": "Contacts",
    "address": "South-Eastern Finland University of Applied Sciences PL 68 (Patteristonkatu 3 D) 50101 Mikkeli",
    "y-code": "Y-code: 2472908-2",
    "campus-num": "campus info: +357 40 647 4456",
    "header2": "Send feedback",
    "email": "email",
    "message": "message",
    "sendButton": "Send",
    "placeholder1": "Email...",
  ...
  "contact":{
    "header1": "Yhteystiedot",
    "address": "Kaakkois-Suomen ammattikorkeakoulu PL 68 (Patteristonkatu 3 D) 50101 Mikkeli",
    "y-code": "Y-tunnus: 2472908-2",
    "campus-num": "Kampusinfo: +357 40 647 4456",
    "header2": "Lähetä palautetta",
    "email": "sähköposti",
    "message": "viesti",
    "sendButton": "Lähetä",
